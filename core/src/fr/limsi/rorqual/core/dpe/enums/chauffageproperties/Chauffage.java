...
public class Chauffage {
    ...
    public enum Generateur {
        ...
        CHAUDIERE_GAZ_CLASSIQUE_AVANT_1981("Chaudière gaz classique (avant 1981)"),
        ...
        CHAUDIERE_GAZ_CONDENSATION_AVANT_1986("Chaudière gaz à condensation (avant 1986)"),
        ...
        CHAUDIERE_FIOUL_CLASSIQUE_AVANT_1970("Chaudière fioul classique (avant 1970)"),
        ...
        CHAUDIERE_FIOUL_STANDARD_APRES_1991("Chaudière fioul standard (après 1991)"),
        ...
        CHAUDIERE_BOIS_PLUS_DE_15_ANS("Chaudière bois ancienne (> 15 ans)"),
        CHAUDIERE_BOIS_MOINS_DE_15_ANS("Chaudière bois récente (< 15 ans)"),
        ...
        RADIATEUR_GAZ_AVANT_2006("Radiateur gaz (avant 2006)"),
        RADIATEUR_GAZ_APRES_2006("Radiateur gaz (après 2006)"),
        POIL_OU_INSERT_BOIS_AVANT_2001("Poil ou insert bois installé avant 2001"),
        POIL_OU_INSERT_BOIS_APRES_2001("Poil ou insert bois installé après 2001"),
