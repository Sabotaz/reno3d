...
/**
 * Created by christophe on 24/06/15.
 */
 /*******************************************************************************
...
public class NinePatch3d {
    ...
    public NinePatch3d(NinePatch patch) {
        this(new TextureRegion(patch.getTexture()), (int)patch.getLeftWidth(), (int)patch.getRightWidth(), (int)patch.getTopHeight(), (int)patch.getBottomHeight());
    }
    ...
    public NinePatch3d (Texture texture, int left, int right, int top, int bottom) {
     ...
     * @param top Pixels from top edge.
     * @param bottom Pixels from bottom edge. */
    public NinePatch3d (TextureRegion region, int left, int right, int top, int bottom) {
    ...
    public void setSize(float x, float y, float width, float height) {
        ...
        final float c = tmpDrawColor.set(color).toFloatBits();
