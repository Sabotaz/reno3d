...
public class RectangleProfileDefModel extends AbstractModelProvider {
    ...
    public RectangleProfileDefModel(IfcRectangleProfileDef rectangleProfileDef) {
        ...
        Vector3 v1 = new Vector3(-xdim*0.5f,-ydim*0.5f,0);
        Vector3 v2 = new Vector3(+xdim*0.5f,-ydim*0.5f,0);
        Vector3 v3 = new Vector3(+xdim*0.5f,+ydim*0.5f,0);
        Vector3 v4 = new Vector3(-xdim*0.5f,+ydim*0.5f,0);
