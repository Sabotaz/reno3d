...
public class IfcWallModelFactory {
    ...
    private void buildModel() {
        ...
        for (int i = 0; i < materialLayersThickness.size(); i++) {
            ...
            Vector3 corner100 = corner000.cpy().add(z_shape);
            Vector3 corner101 = corner001.cpy().add(z_shape);
            Vector3 corner110 = corner010.cpy().add(z_shape);
            Vector3 corner111 = corner011.cpy().add(z_shape);
            meshBuilder.box(corner000, corner001, corner011, corner010, corner100, corner101, corner111, corner110);
        }
        model = builder.end();
    }
