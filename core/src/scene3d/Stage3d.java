...
public class Stage3d extends InputAdapter implements Disposable {
	...
	/** Calls the {@link com.badlogic.gdx.scenes.scene2d.Actor#act(float)} method on each actor in the stage. Typically called each frame. This method also fires
	 ...
	 * @see com.badlogic.gdx.scenes.scene2d.Group#addActor(com.badlogic.gdx.scenes.scene2d.Actor)
	 ...
	 * @see com.badlogic.gdx.scenes.scene2d.Group#addAction3d(Action) */
	public void addAction3d(Action3d action) {
		root.addAction3d(action);
	}

	/** Returns the root's child actors.
	 * @see com.badlogic.gdx.scenes.scene2d.Group#getChildren() */
	 ...
	 * @see com.badlogic.gdx.scenes.scene2d.Actor#removeListener(com.badlogic.gdx.scenes.scene2d.EventListener) */
	 ...
	 * after the camera is set. {@link Stage#draw()} will call {@link com.badlogic.gdx.graphics.Camera#update()} and use the {@link com.badlogic.gdx.graphics.Camera#combined} matrix
