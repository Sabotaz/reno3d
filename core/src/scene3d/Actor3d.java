...
public class Actor3d extends ModelInstance implements Disposable {
	 ...
	 * @see com.badlogic.gdx.scenes.scene2d.Group#removeActor3d(scene3d.Actor3d) */
	...
	public boolean isCullable(final Camera cam) {
	    return cam.frustum.sphereInFrustum(getTransform().getTranslation(position).cpy().add(center), radius);
    }
	 ...
	 * @see com.badlogic.gdx.scenes.scene2d.Group#findActor(String) */
