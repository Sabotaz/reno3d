...
public class IfcModel
{
	 ...
	 * @param isTypeCacheEnabled true for type caching, see {@link ifc2x3javatoolbox.ifcmodel.IfcModel#setTypeCacheEnabled(boolean)}
	 * otherwise false
	 */
	...
	/**
	 * This method reads an IFCZIP file from the specified {@link java.io.File} and initializes the described Objects.
	...
	/**
	 * This method reads an IFCZIP file from the specified {@link java.net.URL} and initializes the described Objects.
	 * Those objects can be accessed and manipulated using the IfcModel's methods.
	...
	/**
	 * This method reads an IFCZIP file from the specified {@link java.io.InputStream} and initializes the described Objects.
	 * Those objects can be accessed and manipulated using the IfcModel's methods.
	...
	/**
	 * This method reads an IFC STEP file from the specified {@link java.net.URL} and initializes the described Objects.
	 * Those objects can be accessed and manipulated using the IfcModel's methods.
	 * @param url the web address to be read from
	 * @throws Exception if an IO failure occurs
	 */
	...
	/**
	 * This method reads an IFC STEP file from the specified {@link java.io.File} and initializes the described Objects.
	 * Those objects can be accessed and manipulated using the IfcModel's methods.
	 * @param file the file to be read from
	 * @throws Exception if an IO failure occurs
	 */
	...
	/**
	 * This method reads an IFC STEP file from the specified {@link java.io.InputStream} and initializes the described Objects.
	 * Those objects can be accessed and manipulated using the IfcModel's methods.
	 * @param inputStream the data source to be read from
	 * @throws Exception if an IO failure occurs
	 */
	...
	/**
	 * Internal method to write an IFCZIP file to the specified {@link java.util.zip.ZipOutputStream}.
	...
	/**
	 * Writes an IFCZIP file that represents the IfcModel's content to the specified {@link java.io.File}.
	...
	/**
	 * Writes an IFCZIP file that represents the IfcModel's content to the specified {@link java.net.URL}.
	...
	/**
	 * Writes an IFCZIP file that represents the IfcModel's content to the specified {@link java.io.OutputStream}.
	 ...
	 * @throws java.io.IOException if an IO failure occurs
	 * @deprecated use instead one of {@link #writeIfcZipFile(java.io.File)}, {@link #writeIfcZipFile(java.net.URL)} or {@link #writeIfcZipFile(java.io.OutputStream)}
	 */
	@Deprecated
	...
	/**
	 * Internal method to write the IFC file header to the specified {@link java.io.OutputStream}
	...
	/**
	 * Internal method to write an IFC STEP file to the specified {@link java.io.OutputStream}.
	...
	/**
	 * Writes an IFC STEP file that represents the IfcModel's content to the specified {@link java.io.File}.
	...
	/**
	 * Writes an IFC STEP file that represents the IfcModel's content to the specified {@link java.net.URL}.
	...
	/**
	 * Writes an IFC STEP file that represents the IfcModel's content to the specified {@link java.io.OutputStream}.
	 * @param outputStream the data sink, where the content should be streamed to
	 * @throws java.io.IOException if an IO failure occurs
	 */
