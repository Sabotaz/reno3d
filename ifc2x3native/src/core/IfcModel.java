...
public class IfcModel {
    ...
    IfcRules.IFCLOCALPLACEMENT ACTIVE_IFCBUILDINGSTOREY_IFCLOCALPLACEMENT;
    ...
    public void STOREY(String name, float elevation) {
        ...
        ACTIVE_IFCBUILDINGSTOREY_IFCLOCALPLACEMENT = IFCLOCALPLACEMENT;
    }
    ...
    public void SLAB(String name, float[][] coins, float height) {
        ...
        IfcRules.IFCDIRECTION IFCDIRECTION2 = new IfcRules.IFCDIRECTION(1,0,0);
        IfcRules.IFCAXIS2PLACEMENT3D IFCAXIS2PLACEMENT3D = new IfcRules.IFCAXIS2PLACEMENT3D(IFCCARTESIANPOINT, IFCDIRECTION1, IFCDIRECTION2);
        IfcRules.IFCLOCALPLACEMENT IFCLOCALPLACEMENT = new IfcRules.IFCLOCALPLACEMENT(ACTIVE_IFCBUILDINGSTOREY_IFCLOCALPLACEMENT, IFCAXIS2PLACEMENT3D);
    ...
    public IfcRules WALL(String etage_name, int etage_number, float mur_ax, float mur_ay, float mur_bx, float mur_by, float mur_depth, float mur_height) {
