...
public class IfcModel {
    ...
    public void SLAB(String name, float[][] coins, float height) {
        ...
        IfcRules.IFCPOLYLINE IFCPOLYLINE = new IfcRules.IFCPOLYLINE((IfcRules.IFCCARTESIANPOINT[]) IFCCARTESIANPOINTS.toArray());
        ...
        IfcRules.IFCSHAPEREPRESENTATION IFCSHAPEREPRESENTATION = new IfcRules.IFCSHAPEREPRESENTATION(IFCGEOMETRICREPRESENTATIONCONTEXT, IFCEXTRUDEDAREASOLID);
        IfcRules.IFCPRODUCTDEFINITIONSHAPE IFCPRODUCTDEFINITIONSHAPE = new IfcRules.IFCPRODUCTDEFINITIONSHAPE(IFCSHAPEREPRESENTATION);
